...
Users can run it directly by placing the unzipped data file and AutoRes-1.0 file in the same directory after downloading.[git clone](https://github.com/dyjfan/AutoRes)
